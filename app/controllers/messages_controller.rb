class MessagesController < ApplicationController
  ...
  def create
    ...
    @message2 = Message.new(user_id: params[:recipient_id], recipient_id: params[:user_id], chat_id: params[:recipient_chat_id], recipient_chat_id: params[:chat_id], content: params[:content])
    @message2.save!
